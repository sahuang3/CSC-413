public class Garden extends Room {
    public String update(String state, String progress) {
        ...
        if (state.equals("look") && roomState.equals("")) {
            ...
            return "found_statue";
        } else if (state.equals("look") && roomState.equals("found_statue")) {
            // Case: input state says user entered "look" command
            ...
            this.state = "found_statue";
            return "found_statue";
        } else if (state.equals("look_statue") && roomState.equals("found_statue")) {
            ...
            return "look_statue";
        } else if (state.equals("use_orb") && progress.equals("use_well")) {
            // Case: User has orb.
            System.out.println("""
